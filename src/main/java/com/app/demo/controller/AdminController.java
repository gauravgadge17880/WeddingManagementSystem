...
//		String keyword="gana";
	...
	//Model find and fill for User
		@RequestMapping(value="userfind/{id}",method=RequestMethod.GET,produces =MimeTypeUtils.APPLICATION_JSON_VALUE) //APPLICATION_JSON_VALUE. A String equivalent of APPLICATION_JSON . static final MimeType. APPLICATION_OCTET_STREAM. Public constant mime type for application
